...
// ملاحظة: هذه بيانات "بذرة" أولية فقط — تُستخدم لتعبئة قاعدة البيانات أول مرة فقط إن كانت فارغة.
// بعد ذلك، البرامج والمدراء الفعليون يُدارون ديناميكيًا من لوحة "⚙️ إدارة البرامج والمدراء" داخل المنصة.
...
// قائمة مدراء البرامج التنفيذية بالمحافظة والبرامج التنفيذية — تُملأ ديناميكيًا وقت التشغيل من Firestore
// (انظر listenToPrograms و listenToManagersList في index.html)
let PROGRAMS = [];
let GOV_MANAGERS = [];
